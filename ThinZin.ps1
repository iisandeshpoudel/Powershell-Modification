...
Invoke-WebRequest "https://github.com/ryanoasis/nerd-fonts/releases/download/v2.1.0/CascadiaCode.zip?WT.mc_id=-blog-scottha" -OutFile "$([Environment]::GetFolderPath('Desktop'))\CascadiaCode.zip"

#Context ma "Code garum hai" add garni
Invoke-RestMethod https://raw.githubusercontent.com/iisandeshpoudel/Powershell-Modification/main/ContextMenu.ps1

#For joson file set up
